      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 space-y-10">
        ...
        <section className="text-center space-y-6">
          ...
          <div className="flex justify-center mt-6">
            <div className="inline-flex items-center p-1.5 rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm relative">
              <button
                onClick={() => setActiveTab("overview")}
                className={cn(
                  "px-8 py-2 rounded-full text-sm font-medium transition-all duration-300 relative z-10",
                  activeTab === "overview"
...
function SummaryCard({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden flex flex-col justify-between h-full p-6 rounded-3xl transition-all duration-500 group",
      ...
      <div className="mt-6 relative z-10 space-y-1">
        ...
        {sub && (
          <div className="flex items-center">
            <p className="text-xs font-medium text-[#50B78B] uppercase tracking-wide opacity-90">
              {sub}
            </p>
          </div>
        )}
...
function MetricFlowItem({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center p-3 rounded-lg transition-colors cursor-default",
        styles.bg
      )}
    >
      <div
        className={cn(
          "mb-2 transform transition-transform group-hover:scale-110",
          styles.icon
        )}
      >
        {icon}
      ...
      <span
        className={cn("text-xl leading-none", styles.count)}
      >
        {count}
      </span>
